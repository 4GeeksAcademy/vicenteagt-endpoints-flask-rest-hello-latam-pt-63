...
from models import db, Users_StarWars, Characters_StarWars, Planets_StarWars, Starships_StarWars, User_Favorites_Characters, User_Favorites_Planets, User_Favorites_Starships
